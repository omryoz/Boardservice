...
package com.board.games.service.nodebb;

import org.apache.log4j.Logger;
import org.springframework.context.ApplicationContext;

import com.board.games.handler.nodebb.NodeBBPokerLoginServiceImpl;
...
@Singleton
public class NodeBBBoardService extends CommonBoardService {

	private NodeBBPokerLoginServiceImpl loginServiceImpl = new NodeBBPokerLoginServiceImpl();
	...
	public void init(ServiceContext con) throws SystemException { 
		log.debug("NodeBBBoardService Initialized");
		setDaoConfig("nodebbDAO");
		super.init(con);	
	}
