...
package com.board.games.service.mybb;

import org.apache.log4j.Logger;
import org.springframework.context.ApplicationContext;

import com.board.games.handler.mybb.MyBBPokerLoginServiceImpl;
...
@Singleton
public class MyBBBoardService extends CommonBoardService {

	private MyBBPokerLoginServiceImpl loginServiceImpl = new MyBBPokerLoginServiceImpl();
	...
	public void init(ServiceContext con) throws SystemException { 
		log.debug("MyBBBoardService Initialized");
		setDaoConfig("mybbDAO");
		super.init(con);	
	}
