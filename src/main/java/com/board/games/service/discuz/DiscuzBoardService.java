...
package com.board.games.service.discuz;

import org.apache.log4j.Logger;
import org.springframework.context.ApplicationContext;

import com.board.games.handler.discuz.DiscuzPokerLoginServiceImpl;
...
@Singleton
public class DiscuzBoardService extends CommonBoardService {

	private DiscuzPokerLoginServiceImpl loginServiceImpl = new DiscuzPokerLoginServiceImpl();
	...
	public void init(ServiceContext con) throws SystemException { 
		log.debug("DiscuzBoardService Initialized");
		setDaoConfig("discuzDAO");
		super.init(con);
	}
	
	@Override
	public ClientServiceAction onAction(ServiceAction action) {
		log.debug("Inside onAction of DiscuzBoardService");
