...
package com.board.games.service.xbtit;


import org.apache.log4j.Logger;
import org.springframework.context.ApplicationContext;

import com.board.games.handler.xbtit.XbtitPokerLoginServiceImpl;
...
@Singleton
public class XbtitBoardService extends CommonBoardService {

	private XbtitPokerLoginServiceImpl loginServiceImpl = new XbtitPokerLoginServiceImpl();
	...
	public void init(ServiceContext con) throws SystemException { 
		log.debug("XbtitBoardService Initialized");
		setDaoConfig("xbtitDAO");
		super.init(con);
