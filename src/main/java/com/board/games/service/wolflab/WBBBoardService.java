...
package com.board.games.service.wolflab;

import org.apache.log4j.Logger;
import org.springframework.context.ApplicationContext;

import com.board.games.handler.wolflab.WBBPokerLoginServiceImpl;
...
@Singleton
public class WBBBoardService extends CommonBoardService {

	private WBBPokerLoginServiceImpl loginServiceImpl = new WBBPokerLoginServiceImpl();
	...
	public void init(ServiceContext con) throws SystemException { 
		log.debug("WolflabBoardService Initialized");
		setDaoConfig("wbbDAO");
		super.init(con);	
	}
