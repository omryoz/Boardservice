...
package com.board.games.service.vanilla;
...
import com.board.games.handler.vanilla.VanillaPokerLoginServiceImpl;
...
@Singleton
public class VanillaBoardService extends CommonBoardService {

	private VanillaPokerLoginServiceImpl loginServiceImpl = new VanillaPokerLoginServiceImpl();
	...
	public void init(ServiceContext con) throws SystemException { 
		log.debug("VanillaBoardService Initialized");
		setDaoConfig("vanillaDAO");
		super.init(con);
