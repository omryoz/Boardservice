...
package com.board.games.service.dolphin;


import org.apache.log4j.Logger;
import org.springframework.context.ApplicationContext;

import com.board.games.handler.dolphin.DolphinPokerLoginServiceImpl;
...
@Singleton
public class DolphinBoardService extends CommonBoardService {

	private DolphinPokerLoginServiceImpl loginServiceImpl = new DolphinPokerLoginServiceImpl();
	...
	public void init(ServiceContext con) throws SystemException { 
		log.debug("DolphinBoardService Initialized");
		setDaoConfig("dolphinDAO");
		super.init(con);
